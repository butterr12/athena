...
const stopCapture = () => {
  ...
  try {
    ...
    const res = await fetch("http://0.0.0.0:42069/describe/", {
      method: "POST",
      body: formData,
    });
    ...
    console.error(err);
    setDescription("Server not running. Contact the website ownner to enable the FastAPI server to fetch captions.");
  }
};
